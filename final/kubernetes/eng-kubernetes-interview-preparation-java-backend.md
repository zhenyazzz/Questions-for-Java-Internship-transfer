...
- [Control Plane and Reconciliation](#control-plane-and-reconciliation)
- [Pods, Lifecycle, and Failure Semantics](#pods-lifecycle-and-failure-semantics)
- [Networking and Traffic Flow](#networking-and-traffic-flow)
- [Deployments, Rollouts, and Release Failure Modes](#deployments-rollouts-and-release-failure-modes)
- [Resource Management and Scaling](#resource-management-and-scaling)
- [Java Runtime in Kubernetes](#java-runtime-in-kubernetes)
- [Stateful Workloads and Storage](#stateful-workloads-and-storage)
- [Configuration, Secrets, and Runtime Contracts](#configuration-secrets-and-runtime-contracts)
- [Security Boundaries That Matter Operationally](#security-boundaries-that-matter-operationally)
...
### API server and eventual consistency
...
### Controllers, ownership, and selectors
...
### Ephemeral Pods and durable state
...
### Pod phases vs production readiness
...
### Pod IPs, Services, and endpoints
...
### kube-proxy and ClusterIP routing
...
### Timing bugs and readiness depth
...
### Rollbacks and schema compatibility
...
### JVM sizing vs container limits
...
### Spring Boot startup and probes
...
### Thread pools and per-Pod concurrency
...
### Databases in-cluster vs managed
...
### Init containers and migrations
...
### Request path vs reconciliation path
...
### Shallow readiness during rollout
...
### HPA exhausts database connections
...
### StatefulSet volume stuck after node failure
